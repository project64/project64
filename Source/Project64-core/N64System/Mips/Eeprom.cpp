...
void CEeprom::EepromCommand(uint8_t * Command)
{
    ...
    case 7: // Read RTC block
        ...
        case 0: // Block number
            ...
            break;
        case 1:
            // Read block, Command[2], unimplemented (TODO: implement?)
            break;
        case 2: // Set RTC time
            time(&curtime_time);
            memcpy(&curtime, localtime(&curtime_time), sizeof(curtime)); // FD's fix (TODO: Who/what is "fd" and what is the fix?)
        ...
        break;
    case 8:
        // Write RTC, unimplemented (TODO: implement?)
