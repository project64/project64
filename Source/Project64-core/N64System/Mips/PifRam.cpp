...
void CPifRam::PifRamRead()
{
    ...
    for (int32_t CurPos = 0; CurPos < 0x40; CurPos++)
    {
        ...
        case 0xFF: break;
        case 0xB4: case 0x56: case 0xB8: break; // TODO: ???
        default:
...
void CPifRam::PifRamWrite()
{
    ...
    if (m_PifRam[0x3F] > 0x1)
    {
        ...
        {
        case 0x02:
            // TODO: Better explanation and/or documentation. Format the 'challenge' message into 30 nibbles for X-Scale's CIC code
            {
