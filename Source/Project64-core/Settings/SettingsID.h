...
enum SettingID
{
    ...
    Netplay_FastSP,
    Netplay_FixedAudio,
    Netplay_SyncViaAudio,
    Netplay_RspAudioSignal,
    Netplay_TLB_VAddrStart,
    Netplay_TLB_VAddrLen,
    Netplay_TLB_PAddrStart,
    Netplay_UseHleGfx,
    Netplay_UseHleAudio,
    Netplay_LoadRomToMemory,
    Netplay_ScreenHertz,
    Netplay_FuncLookupMode,
    Netplay_RegCache,
    Netplay_BlockLinking,
    Netplay_SMM_StoreInstruc,
    Netplay_SMM_Cache,
    Netplay_SMM_PIDMA,
    Netplay_SMM_TLB,
    Netplay_SMM_Protect,
    Netplay_SMM_ValidFunc,
    Netplay_GameCheatFix,
    Netplay_GameCheatFixPlugin,
    Netplay_ViRefreshRate,
    Netplay_AiCountPerBytes,
    Netplay_AudioResetOnLoad,
    Netplay_AllowROMWrites,
    Netplay_CRC_Recalc,
    Netplay_OverClockModifier,
    Netplay_FullSpeed,
