...
private:
    ...
    static constexpr ASM_SYNTAX_FN syn_jump[]       = { arg_jump, NULL };
    static constexpr ASM_SYNTAX_FN syn_loadstore[]  = { arg_reg_t, arg_imm16, arg_reg_s, NULL };
    static constexpr ASM_SYNTAX_FN syn_arith[]      = { arg_reg_d, arg_reg_s, arg_reg_t, NULL };
    static constexpr ASM_SYNTAX_FN syn_arith2[]     = { arg_reg_s, arg_reg_t, NULL };
    static constexpr ASM_SYNTAX_FN syn_shiftv[]     = { arg_reg_d, arg_reg_t, arg_reg_s, NULL };
    static constexpr ASM_SYNTAX_FN syn_arith_i[]    = { arg_reg_t, arg_reg_s, arg_imm16, NULL };
    static constexpr ASM_SYNTAX_FN syn_load_i[]     = { arg_reg_t, arg_imm16, NULL };
    static constexpr ASM_SYNTAX_FN syn_branch_z[]   = { arg_reg_s, arg_bra_target, NULL };
    static constexpr ASM_SYNTAX_FN syn_branch[]     = { arg_reg_s, arg_reg_t, arg_bra_target, NULL };
    static constexpr ASM_SYNTAX_FN syn_branch_unc[] = { arg_bra_target, NULL };
    static constexpr ASM_SYNTAX_FN syn_trap_i[]     = { arg_reg_s, arg_imm16, NULL };
    static constexpr ASM_SYNTAX_FN syn_shift[]      = { arg_reg_d, arg_reg_t, arg_shamt, NULL };
    static constexpr ASM_SYNTAX_FN syn_mf[]         = { arg_reg_d, NULL };
    static constexpr ASM_SYNTAX_FN syn_jr[]         = { arg_reg_s, NULL };
    static constexpr ASM_SYNTAX_FN syn_jalr[]       = { arg_reg_d, arg_reg_s, NULL };
    static constexpr ASM_SYNTAX_FN syn_cop1_arith[] = { arg_reg_fd, arg_reg_fs, arg_reg_ft, NULL };
    static constexpr ASM_SYNTAX_FN syn_cop1[]       = { arg_reg_fd, arg_reg_fs, NULL };
    static constexpr ASM_SYNTAX_FN syn_cop1_cmp[]   = { arg_reg_fs, arg_reg_ft, NULL };
    static constexpr ASM_SYNTAX_FN syn_cop_mv[]     = { arg_reg_t, arg_reg_d, NULL };
    static constexpr ASM_SYNTAX_FN syn_cache[]      = { arg_cache_op, arg_imm16, arg_reg_s, NULL };
    static constexpr ASM_SYNTAX_FN syn_syscall[]    = { arg_syscall_code, NULL };

    static constexpr ASM_INSTRUCTION m_Instructions[] =
    {
    ...
    static constexpr ASM_REGISTER m_Registers[] =
    {
