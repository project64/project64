...
bool CMainMenu::ProcessMessage(HWND hWnd, DWORD /*FromAccelerator*/, DWORD MenuID)
{
    ...
    case ID_HELP_WEBSITE: ShellExecute(NULL, L"open", L"https://www.pj64-emu.com", NULL, NULL, SW_SHOWMAXIMIZED); break;
...
void CMainMenu::FillOutMenu(HMENU hMenu)
{
    ...
    if (HaveDebugger())
    {
        ...
        Item.Reset(ID_DEBUGGER_TRACE_APPINIT, EMPTY_STRING, EMPTY_STDSTR, NULL, L"App initialization");
        ...
        DebugNotificationMenu.push_back(Item);
        Item.Reset(ID_DEBUG_SHOW_DIV_BY_ZERO, EMPTY_STRING, EMPTY_STDSTR, NULL, L"On division by zero errors");
