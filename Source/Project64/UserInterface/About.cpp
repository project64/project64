...
LRESULT CAboutDlg::OnInitDialog(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL & bHandled)
{
    ...
    AboutMsg += "Project64 is a completely free and open-source emulator for the Nintendo 64 and 64DD written in C++.\n\nCapable of playing your favorite N64 games on your PC with high definition graphics & sound, excellent compatibility, save states, built-in cheat codes, and more.";
    ...
    SetWindowDetais(IDC_THANKYOU_LIST, IDC_THANKYOU, L"Jahra!n, Witten, RadeonUser, Azimer, Shygoo, Frank, LuigiBlood, Alen Alic, theboy181, Gonetz, BlueToonYoshi, Kimbjo, Melchior, retroben, AIO, krom, Abdu, Skittles, ZaxLofful", m_TextFont);
