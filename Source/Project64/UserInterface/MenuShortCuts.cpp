...
void CShortCuts::Load(bool InitialValues)
{
    ...
    AddShortCut(ID_FILE_STARTNETPLAY, STR_SHORTCUT_FILEMENU, MENU_NETPLAY, CMenuShortCutKey::ACCESS_GAME_NOT_RUNNING);
    ...
    AddShortCut(ID_OPTIONS_CONFIG_NET, STR_SHORTCUT_OPTIONS, MENU_CONFG_NET, CMenuShortCutKey::ACCESS_NOT_IN_FULLSCREEN);
