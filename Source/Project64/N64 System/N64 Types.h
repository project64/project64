...
enum FRAMERATE_TYPE 
{
	FR_VIs = 0, FR_DLs = 1, FR_PERCENT = 2, FR_VIs_DLs = 3, //added for FPS addion//
};
...
enum Country 
{ 
	NTSC_BETA	= 0x37,		X_NTSC	= 0x41,		Germany			= 0x44,		USA			= 0x45,		french		= 0x46,		
	Italian		= 0x49,		Japan	= 0x4A,		Europe			= 0x50,		Spanish		= 0x53,		Australia	= 0x55,		
	X_PAL		= 0x58,		Y_PAL	= 0x59,		UnknownCountry	= 0
};
