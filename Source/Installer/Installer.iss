...
Name: "{commonprograms}\Project64 3.0\Project64"; Filename: "{app}\Project64.exe"
Name: "{commonprograms}\Project64 3.0\Uninstall Project64 3.0"; Filename: "{uninstallexe}"; Parameters: "/LOG"; Flags: createonlyiffileexists
Name: "{commonprograms}\Project64 3.0\Support"; Filename: "https://discord.gg/Cg3zquF"
